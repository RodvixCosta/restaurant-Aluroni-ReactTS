		...
		<section>
			...
			<div className={styles.sobreNos}>
				...
				<div className={styles.sobreNos__texto}>
					<p>
                        Nós do Aluroni oferecemos a vocês, a Massa Italiana Caseira mais saborosa e sofisticada de São Paulo! Prezamos pelos ingredientes tradicionais da culinária Italiana, frescos e de excelente qualidade para que sua experiência seja ainda mais intensa!
					</p>
					<p>
